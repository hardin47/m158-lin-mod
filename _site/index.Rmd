...
schedule <- tribble(
  ...
  '<a href="https://happygitwithr.com/" target = "_blank"><i class="fa fa-comments"></i> happygitwithR</a>',
    "Week 2 <br> 1.25.22", 'Inference',"$\\boldsymbol{\\cdot}$Inf on $\\beta_1$ <br> $\\boldsymbol{\\cdot}$CI for $\\beta_1$ <br> $\\boldsymbol{\\cdot}$CI for mean <br> $\\boldsymbol{\\cdot}$PI for indiv", 
  ...
  '<a href="" target = "_blank"><i class="fas fa-desktop"></i> </a> <br> <a href="https://m158-lin-mod.netlify.app/slides/wu3_ma158_s22.pdf" target = "_blank"><i class="fas fa-pencil-alt"></i> WU 3</a> <br> <a href="" target = "_blank"><i class="fas fa-pencil-alt"></i> WU 4</a>',
