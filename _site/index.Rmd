...
schedule <- tribble(
  ...
  '<a href="" target = "_blank"><i class="fas fa-desktop"></i> </a> <br> <a href="https://m158-lin-mod.netlify.app/slides/wu18_ma158_s22.pdf" target = "_blank"><i class="fas fa-pencil-alt"></i> WU 18</a>',
  '<a href="" target = "_blank"><i class="fa fa-comments"></i> </a>',  
