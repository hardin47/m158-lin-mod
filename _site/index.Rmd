...
schedule <- tribble(
  ...
  '',
    "Week 3 <br> 2.1.22", 'Diagnositcs',"$\\boldsymbol{\\cdot}$ $R^2$ <br> $\\boldsymbol{\\cdot}$ F test<br> ", 
  ...
  '<a href="" target = "_blank"><i class="fas fa-desktop"></i> </a> <br> <a href="https://m158-lin-mod.netlify.app/slides/wu4_ma158_s22.pdf" target = "_blank"><i class="fas fa-pencil-alt"></i> WU 4</a><br> <a href="" target = "_blank"><i class="fas fa-pencil-alt"></i> WU</a>',
