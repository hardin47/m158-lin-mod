...
schedule <- tribble(
  ...
  '<a href="" target = "_blank"><i class="fas fa-desktop"></i> </a> <br> <a href="https://m158-lin-mod.netlify.app/slides/wu3_ma158_s22.pdf" target = "_blank"><i class="fas fa-pencil-alt"></i> WU 3</a> <br> <a href="https://m158-lin-mod.netlify.app/slides/wu4_ma158_s22.pdf" target = "_blank"><i class="fas fa-pencil-alt"></i> WU 4</a>',
  
  '<a href="" target = "_blank"><i class="fa fa-comments"></i> </a>',
    "Week 3 <br> 2.1.22", 'Diagnositcs',"$\\boldsymbol{\\cdot}$ <br> ", 
  '<a href="https://st47s.com/Math158/Notes/diag1.html" target = "_blank"><i class="fas fa-book-open"></i> Diagnostics I</a><br>  <br> <i class="fas fa-book-open"></i> ALSM 3',
  '<a href="" target = "_blank"><i class="fas fa-desktop"></i> </a> <br> <a href="" target = "_blank"><i class="fas fa-pencil-alt"></i> WU</a>',
  '<a href="" target = "_blank"><i class="fa fa-comments"></i> </a>',
    "Week 4 <br> 2.8.22", 'Simultaneous <br> Inference + <br> Matrices',"$\\boldsymbol{\\cdot}$ <br> ", 
  ...
  '',
  '<a href="" target = "_blank"><i class="fas fa-pencil-alt"></i> Proj 1: Data</a>',
  '',
    "Week 5 <br> 2.15.22", 'MLR',"$\\boldsymbol{\\cdot}$ <br> ", 
  ...
  '',
  '<a href="" target = "_blank"><i class="fas fa-pencil-alt"></i> Proj 2: SLR</a>',
  '',
      "Week 6 <br> 2.22.22", 'catch-up',"$\\boldsymbol{\\cdot}$ <br> ", 
  '<a href="" target = "_blank"><i class="fas fa-book-open"></i> </a> <br> <a href="" target = "_blank"><i class="fas fa-book-open"></i></a>',
  '<a href="" target = "_blank"><i class="fas fa-desktop"></i> </a> <br> <a href="" target = "_blank"><i class="fas fa-pencil-alt"></i> WU</a>',
  '<a href="" target = "_blank"><i class="fa fa-comments"></i> </a>',
  ...
  '',
  '',    
  "Week 7 <br> 3.1.22", 'MLR',"$\\boldsymbol{\\cdot}$ <br> ", 
  '<a href="https://st47s.com/Math158/Notes/mlr.html" target = "_blank"><i class="fas fa-book-open"></i> MLR</a> <br> <i class="fas fa-book-open"></i> ALSM 7 </a>',
  '<a href="" target = "_blank"><i class="fas fa-desktop"></i> </a> <br> <a href="" target = "_blank"><i class="fas fa-pencil-alt"></i> WU</a>',
  '<a href="" target = "_blank"><i class="fa fa-comments"></i> </a>',
  ...
  '',
  '<a href="" target = "_blank"><i class="fas fa-pencil-alt"></i> Proj 3: MLR</a>',
  '',
