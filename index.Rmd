...
schedule <- tribble(
  ...
  '',
  '',      
  "Week 9 <br> 3.22.22", 'Model <br>Building',"$\\boldsymbol{\\cdot}$ mulicollinearity <br> $\\boldsymbol{\\cdot}$ <br>stepwise <br> procedures ", 
  ...
  '<a href="https://m158-lin-mod.netlify.app/slides/modelStrategy.pdf" target = "_blank"><i class="fas fa-book-open"></i> Model Strategy</a> <br> <a href="https://m158-lin-mod.netlify.app/slides/wu13_ma158_s22.pdf" target = "_blank"><i class="fas fa-pencil-alt"></i> WU 14</a><br> <a href="" target = "_blank"><i class="fas fa-pencil-alt"></i> WU</a>',
  '',  
  ...
  '<a href="" target = "_blank"><i class="fas fa-desktop"></i> </a> <br> <a href="" target = "_blank"><i class="fas fa-pencil-alt"></i> WU</a> <br> <a href="" target = "_blank"><i class="fas fa-pencil-alt"></i> WU</a>',
