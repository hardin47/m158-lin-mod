...
schedule <- tribble(
  ...
  "1.18.22", 'starting + <br> R + RStudio + <br> Git + GitHub + <br> SLR',"$\\boldsymbol{\\cdot}$course info <br> $\\boldsymbol{\\cdot}$R + Git <br> $\\boldsymbol{\\cdot}$what is a linear model? <br> $\\boldsymbol{\\cdot}$least squares <br> $\\boldsymbol{\\cdot}$norm errors <br> $\\boldsymbol{\\cdot}$tech cond", 
