...
schedule <- tribble(
  ...
  '',
    ...
    "Week 8 <br> 3.8.22", 'Model <br> Building',"$\\boldsymbol{\\cdot}$ sums of squares <br> $\\boldsymbol{\\cdot}$ nested F-tests <br> $\\boldsymbol{\\cdot}$ coef of determination <br> $\\boldsymbol{\\cdot}$ mulicollinearity", 
  ...
  '',
  '',      
  "Week 9 <br> 3.22.22", 'Model <br>Building',"$\\boldsymbol{\\cdot}$ <br> ", 
